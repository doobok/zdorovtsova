<div class="grid grid-cols-1 justify-items-center place-content-start">
    <img class="object-cover w-36 h-36 rounded-full shadow" src="/img/category{{$n}}.jpg" alt="{{__('lnd.dir' . $n)}}"/>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" class="text-green m-5" width="24" height="24"
