    ...
    <div class="container z-30 relative pt-20 sm:pt-36 lg:pt-48 pb-12 sm:pb-24 lg:pb-36">
        <div class="flex flex-col lg:flex-row justify-center items-center">
            ...
            <div class="lg:pl-12 xl:pl-24 pt-8 sm:pt-10 lg:pt-0">
                ...
                <p class="text-white text-base md:text-2xl font-medium my-5">Семейный психолог, сексолог, <br> ведущая
                    психологических групп</p>
                <div class="pt-3 sm:pt-5">
                    ...
                    <div class="pt-8">
                        <p class="text-white text-base md:text-xl font-medium">Записавшись на консультацию Вы
                            получаете:</p>
