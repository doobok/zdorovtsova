  ...
  <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    <div class="grid gap-8 row-gap-0 lg:grid-cols-3">
      <div class="text-center">
        ...
        <p class="max-w-md mb-3 text-lg text-grey-70 sm:mx-auto">
          Профессиональной психологической практики
        </p>
      ...
      <div class="text-center">
        ...
        <p class="max-w-md mb-3 text-lg text-grey-70 sm:mx-auto">
          Индивидуальных и групповых психологических тренингов
        </p>
        <div class="top-0 right-0 flex items-center justify-center h-24 lg:-mr-8 lg:absolute">
        </div>
      </div>
      <div class="text-center">
        ...
        <div class="my-7 font-extrabold leading-none text-lila flex flex-wrap justify-center">
          <div class="text-lx">
            более
            <div class="text-5xl mx-3">
              <counter-up :max="500"></counter-up>
            </div>
            клиентов
          </div>
        </div>
        <p class="max-w-md mb-3 text-lg text-grey-70 sm:mx-auto">
          В которых в результате консультаций был прогресс
        </p>
        <div class="top-0 right-0 flex items-center justify-center h-24 lg:-mr-8 lg:absolute">
        </div>
      </div>
