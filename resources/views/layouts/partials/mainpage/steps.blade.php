  ...
  <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-36">
    <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
      ...
      <p class="text-base md:text-lg subtitle--bg">
        <span>четыре простых шага, которые помогут Вам</span>
      </p>
    </div>
    <div class="grid gap-8 row-gap-5 md:row-gap-8 lg:grid-cols-4">
      <div class="p-5 duration-300 transform bg-white border-2 border-dashed rounded shadow-sm border-primary hover:-translate-y-2">
        <div class="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-full bg-indigo-50 sm:w-20 sm:h-20">
          <svg class="w-32 h-32 text-grey-20 sm:w-16 sm:h-16" viewBox="0 0 495.003 495.003" fill="currentColor">
      ...
      <div class="p-5 duration-300 transform bg-white border-2 border-dashed rounded shadow-sm border-primary hover:-translate-y-2">
        <div class="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-full bg-indigo-50 sm:w-20 sm:h-20">
          <svg class="w-32 h-32 text-grey-20 sm:w-16 sm:h-16" viewBox="0 0 511.999 511.999" fill="currentColor">
            ...
            <path d="M246.224 16.353c-40.061 0-72.537 23.385-72.537 52.233 0 15.512 9.399 29.437 24.309 39.004l-10.055 20.08a5.198 5.198 0 0 0 7.226 6.841l28.505-16.279c7.1 1.671 14.675 2.587 22.55 2.587 40.063 0 72.538-23.386 72.538-52.233.001-28.848-32.474-52.233-72.536-52.233z"/>
          </svg>
        </div>
        <div class="flex items-center mb-2">
          <p class="flex items-center justify-center w-10 h-10 mr-2 text-lg font-bold text-white rounded-full bg-orange">
    ...
    <div class="flex justify-center pt-12">
      <smpl-button txt="Начать сейчас" cls="text-sm px-7 py-3 sm:px-10 sm:py-4 md:text-lg md:px-16 md:py-5"></smpl-button>
    </div>
  </div>
</div>
